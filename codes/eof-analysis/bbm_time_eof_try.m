%% Idea for EOF that captures temporal distribution of spatial variance
clear all,close all

%load BBM_sample_long
%load bbm_crittry
load ../bbm_tide2crittry
data=B2s;
...
%myx=(0.5:4095.5)/4096; mytime=0:599;
 ...
 % for bbm_tide2crittry
 myx=(0.5:2047.5)/4096; mytime=0:1199;
...
clf
betterplots
plot(myx,coeff(1,:),'b-',myx,coeff(50,:),'k-',myx,coeff(100,:),'r-',myx,coeff(150,:),'g-');
